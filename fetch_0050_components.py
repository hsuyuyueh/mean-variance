...
def fetch_0050_components(CACHE_DIR=DEF_CACHE_DIR):
    today = datetime.today().strftime("%Y%m%d")
    ccache_inputfile = os.path.join("./inputs/TW/fetch_cache", f"0050_components.json")
...
if __name__ == "__main__":
     comps = fetch_0050_components()
     print(f"\n📦 0050 成分股共 {len(comps)} 檔：")
